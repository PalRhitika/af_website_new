...
const timelineItems = [
  ...
  { id: "why", label: "Why TLH", icon: FaPersonCircleQuestion },
  { id: "cohort1", label: "Cohort I", icon: FaUsers },
  { id: "cohort2", label: "Cohort II", icon: FaUsers },
  { id: "sessions", label: "Sessions", icon: FaChalkboardTeacher },
  { id: "graduation", label: "Graduation", icon: FaGraduationCap },
];
